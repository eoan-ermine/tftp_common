...
bool parser::parse(std::uint8_t* data, std::size_t len, std::size_t bytes_read, packets::request& packet) {
	bytes_read = 0;
...
bool parser::parse(std::uint8_t* data, std::size_t len, std::size_t bytes_read, packets::data& packet) {
	bytes_read = 0;
	for (std::size_t i = 0; i != len; ++i) {
		const auto byte = data[i];
		bytes_read++;
...
bool parser::parse(std::uint8_t* data, std::size_t len, std::size_t bytes_read, packets::acknowledgment& packet) {
	bytes_read = 0;
	for (std::size_t i = 0; i != len; ++i) {
		const auto byte = data[i];
		bytes_read++;
...
bool parser::parse(std::uint8_t* data, std::size_t len, std::size_t bytes_read, packets::error& packet) {
	bytes_read = 0;
	for (std::size_t i = 0; i != len; ++i) {
		const auto byte = data[i];
		bytes_read++;
